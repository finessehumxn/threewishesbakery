...
const CATALOG = [
  { name: "The Three Wishes Classic", img: "real-classic.jpg",
  ...
  { name: "Take-&-Bake Cookie Dough", img: "dough-balls.jpg",
    desc: "Three Wishes Classic dough scooped into frozen ready-to-bake pucks. Bake from frozen at 350°F. Keep frozen.",
    prices: [["12 Dough Pucks", 2200], ["24 Dough Pucks", 4000]] },
  { name: "The Fudgy Fortune Brownie", img: "brownie.jpg",
  ...
  { name: "The Citrus Spell", img: "lemon-bar.jpg",
